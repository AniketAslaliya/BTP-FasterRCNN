"""
faster_rcnn_v1.py — Version A
Pure dual ResNet-50 + Concat at C4 + Cross-attention. No CBAM.
"""
import torch
...
class CrossAttentionFusion(nn.Module):
    ...
    def forward(self, rgb_c4, ir_c4):
        ...
        rgb_seq = rgb_c4.flatten(2).permute(0,2,1)
        ir_seq  = ir_c4.flatten(2).permute(0,2,1)
...
class MultimodalBackboneWithFPN(nn.Module):
    def __init__(self, fpn_out=256):
        ...
        self.fusion = CrossAttentionFusion(in_ch=2048, attn_dim=256, num_heads=8)
