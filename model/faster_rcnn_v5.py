...
Changes from V4:
  ...
  - Anchor ratios updated for multi-class: (0.33, 0.5, 1.0, 2.0, 3.0)
...
class FasterRCNN(nn.Module):
    def __init__(self, model_config=None, num_classes=5):
        super().__init__()
        backbone = MultimodalBackboneWithFPN(fpn_out=256)
        anchor_gen = AnchorGenerator(
            sizes=((32,), (64,), (128,), (256,), (512,)),
            aspect_ratios=((0.33, 0.5, 1.0, 2.0, 3.0),) * 5)  # multi-class optimised
